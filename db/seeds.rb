...
c1 = Company.create(company_name: "apple",location: "california",sector: "tech",industry: "computers", exchange_short_name: "nyse")
c2 = Company.create(company_name: "google",location: "seattle",sector: "tech",industry: "data", exchange_short_name: "nasdaq")
c3 = Company.create(company_name: "samsung",location: "california",sector: "tech",industry: "videogames", exchange_short_name: "nyse")
...
Stock.create(ticker: "GOOG", market_cap: 501213000000, price: 141.52, volume: 36423519.4, last_annual_dividend: 0.88, investor_id: b2.id, company_id: c2.id, is_actively_trading: false)
Stock.create(ticker: "META", market_cap: 704220900000, price: 54.67, volume: 13499424.6, last_annual_dividend: 0.31, investor_id: b3.id, company_id: c3.id, is_actively_trading: true)
